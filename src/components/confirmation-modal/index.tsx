...
interface ModalProps {
  ...
  yesText?: string;
  noText?: string;
  alertType: "warning" | "danger" | "delete" | "success";
  title?: string;
  subTitle?: string;
}
                  ...
                  <div className="text-center">
                    {alertType === "warning" && (
                      ...
                      >
                        ...
                        <path
                          ...
                          fill="#FDBA22"
                        />
                        <circle cx="63" cy="18" r="2" fill="#FDBA22" />
                        <circle cx="20" cy="57" r="2" fill="#FDBA22" />
                        <path
                    ...
                    {alertType === "danger" && (
                      ...
                      >
                        ...
                        <path
                          ...
                          fill="#FF3838"
                        />
                        <circle cx="63" cy="18" r="2" fill="#FF3838" />
                        <circle cx="20" cy="57" r="2" fill="#FF3838" />
                        <path
                    ...
                    {alertType === "delete" && (
                      ...
                      >
                        ...
                        />
                        <path
                          d="M54.875 33.75V56.5C54.875 57.362 54.5326 58.1886 53.9231 58.7981C53.3136 59.4076 52.487 59.75 51.625 59.75H35.375C34.513 59.75 33.6864 59.4076 33.0769 58.7981C32.4674 58.1886 32.125 57.362 32.125 56.5V33.75M37 33.75V30.5C37 29.638 37.3424 28.8114 37.9519 28.2019C38.5614 27.5924 39.388 27.25 40.25 27.25H46.75C47.612 27.25 48.4386 27.5924 49.0481 28.2019C49.6576 28.8114 50 29.638 50 30.5V33.75"
                          stroke="#DD2525"
                          stroke-width="2"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                    ...
                    {alertType === "success" && (
                      ...
                      >
                        ...
                        <path
                          ...
                          fill="#1A857D"
                        />
                        <circle cx="63" cy="18" r="2" fill="#27A590" />
                        <circle cx="20" cy="57" r="2" fill="#27A590" />
                        <path
                          ...
                          <button
                            className={cx(
                              "rounded-full w-full h-[2.5rem] font-semibold disabled:opacity-70 flex flex-row justify-center items-center focus:outline-none",
                              {
                                ...
                                "text-[#FF3838]": alertType === "danger"||"delete",
                              }
                            )}
                            onClick={onClose}
                          >
