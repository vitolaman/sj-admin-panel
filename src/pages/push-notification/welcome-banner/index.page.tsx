...
export const welcomeBannerRouteName = "welcome-banner";
export default function WelcomeBanner(): React.ReactElement {
  ...
  const handleCreateBanner = (): void => {
    void push("/push-notification/welcome-banner/create");
  };

  const handleEditBanner = (id: string): void => {
    void push(`/push-notification/welcome-banner/update/${id}`);
  };
