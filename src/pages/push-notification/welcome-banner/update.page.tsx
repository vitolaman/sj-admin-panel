...
import useUpdatePopUpBannerForm from "hooks/push-notification/useUpdatePupUpBannerForm";
...
export const uwbRouteName = "welcome-banner/update/:id";
const UpdateWelcomeBanner = () => {
  ...
  const {
    ...
    handleCreate,
    reset,
  } = useUpdatePopUpBannerForm(params.id!);
...
export default UpdateWelcomeBanner;
