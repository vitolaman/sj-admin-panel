...
import useCreateExclusiveBannerForm from "hooks/banner/useCreateExclusiveBannerForm";
...
export const cebRouteName = "exclussive-banner/create";
const CreateExclussiveBanner = () => {
...
export default CreateExclussiveBanner;
